...
class PeriodoLetivo(Base):
    ...
    ano = Column(Integer, nullable=True)      # Ex: 2026 (do diagrama de entidades)
    periodo = Column(Integer, nullable=True)   # Ex: 1 (do diagrama de entidades)
...
class Turma(Base):
    ...
    status = Column(String(30), default="ABERTA", nullable=False)  # Ex: ABERTA, FECHADA, CANCELADA
