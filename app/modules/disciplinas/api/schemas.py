...
class DisciplinaBase(BaseModel):
    ...
    modalidade: Optional[str] = Field(None, max_length=50, description="Modalidade (Ex: Presencial, EAD, Híbrida)")
    ...
    carga_horaria_teorica: int = Field(default=0, ge=0, description="Carga horária teórica")
